...
public class SaslPlaintextScenario extends AbstractScenario<SaslPlaintextPlainKafkaContainer>{
    ...
    public static void main(String[] args) {
        var scenario = new SaslPlaintextScenario();
        scenario.start();
        scenario.scenario();
        scenario.stop();
    }

    public SaslPlaintextScenario() {
